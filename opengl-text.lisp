...
(defmethod initialize-instance :after ((instance base-opengl-text) &rest initargs)
...
(defmethod (setf length-of) :after (new-value (object base-opengl-text))
...
(defmethod (setf font-loader-of) :around ((new-value string) (object base-opengl-text))
  (setf (font-loader-of object) (get-font-loader new-value)))

(defmethod (setf font-loader-of) :around ((new-value pathname) (object base-opengl-text))
  (setf (font-loader-of object) (get-font-loader new-value)))

(defmethod (setf font-loader-of) :after ((new-value zpb-ttf::font-loader) (object base-opengl-text))
